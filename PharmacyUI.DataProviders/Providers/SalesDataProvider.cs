...
namespace PharmacyUI.DataProviders.Providers
{
    public class SalesDataProvider: ISalesDataProvider
    {
        ...
        public async Task<InvoiceCreateResponse> InvoiceCreate(EditSalesInvoiceRequest request)
        {
        ...
        public async Task<ResponseBuilder> DeleteInvoiceDet(int request)
        {
            return await APIInvoker.PostRequest<ResponseBuilder>(request, APIOrigin.DeleteInvoiceDet());
        }
    }
}
