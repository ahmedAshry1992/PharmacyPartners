#pragma checksum "D:\github\PharmacyPartners\PharmacyPartners.UI\Areas\Pharmacy\Views\Invoice\CreateSalesInvoice.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "825000269d90114c30b86f87bed0821bd8f3a083"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"825000269d90114c30b86f87bed0821bd8f3a083", @"/Areas/Pharmacy/Views/Invoice/CreateSalesInvoice.cshtml")]
        ...
        <div class=""col-xs-5"">
            <div class=""card"">
                ...
                <div class=""card-body"">
                    <div class=""row"">
                        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "825000269d90114c30b86f87bed0821bd8f3a0836363", async() => {
                WriteLiteral("\r\n                            ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("div", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "825000269d90114c30b86f87bed0821bd8f3a0836649", async() => {
                }
                );
...
#nullable disable
                WriteLiteral("                    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "825000269d90114c30b86f87bed0821bd8f3a0838927", async() => {
#nullable restore
    ...
    $(document).ready(function () {
      ...
      ");
        ...
        $("".billtable"").on(""change"", "".prodquantity"", function () {
            ...
            var ");
            WriteLiteral(@"min = parseInt($(this).attr(""min""));
            if ($(this).val() > max) {
                $(this).val(max);
            }
        ...
        $(""body"").off(""click"", "".sel-customer"").on(""click"", "".sel-customer"", function () {
            var $dom = $(this);
            $("".");
            WriteLiteral(@"customerName"").val($dom.attr(""x-cusname""));
        ...
        function recalculeTotal() {
            var total = 0;
  ");
            WriteLiteral(@"          $.each($("".dyna-tbody1 tr""), function () {
                var $dom = $(this);
        ...
        function invoiceObjectCreate(status) {
           ...
           ");
            WriteLiteral(@"     invObject.salesProducts.push(pro);
            });
        ...
        function invoiceObjectEdit(element) {
            ...
            $.each($("".dyna-tbody1 tr""), function () {
                ...
                invObj");
            WriteLiteral(@"ect.salesInvoiceRequest.salesProducts.push(pro);
            });

            pharmacy.Globals.MakeAjaxCall(""Post"", ""invoice/edit"", invObject, function (response) {
                invoiceId = response.data.invoiceId;
                //invoiceDIds = response.data.ids;
                //alert(element);
                //console.log(response);
                $(element).val(response.data.id);
               // $('.invdetId').val(response.data.id);
               // invDid = response.data.id;
